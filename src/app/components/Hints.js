	...
	constructor(props) {
  	...
  	render(){
  		...
  		return (
            ...
            <br/>
            {this.props.currentInstanceNum != 0 && <span data-tip data-for='maxHint'><TiInfoLarge color={orangeA700} /> {t('common:createStep.currentInstance')} : <font color={greenA700}><b>{this.props.currentInstanceNum}</b></font></span>}
