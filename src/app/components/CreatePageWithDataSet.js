...
class CreatePageWithDataSet extends React.Component {
  ...
  checkDataSet = (dataSetPath, dataSetId, dataSetPass, event) => {
    console.log(dataSetPath, dataSetId, dataSetPass, event)
            ...
            {this.state.instanceArr.map((instance)=>(
              <Card style={{borderRadius: '5px', border:'1px solid #e0e0e0', margin: '2px'}}>
                ...
                <TextField
                  ...
                  onChange={this.dataPathSet.bind(null, instance.instance)}
                />
                  { (instance.dataSetPath.length != 0 && instance.dataSetId.length != 0 && instance.dataSetPass.length != 0) &&
                    <FlatButton
                      secondary={true}
                      label={t('common:createStep.check')}
                      icon={ submitting ? <CircularProgress size={25} thickness={2} /> : <ActionCheckCircle />}
                      onTouchTap = {this.checkDataSet.bind(null,instance.dataSetPath,instance.dataSetId,instance.dataSetPass)}
                    />
                  }                
                </div>
                }
...
export default translate('')(CreatePageWithDataSet)